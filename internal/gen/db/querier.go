...
type Querier interface {
	...
	ListStopsInSystemGeo_ByDistance(ctx context.Context, arg ListStopsInSystemGeo_ByDistanceParams) ([]Stop, error)
	ListStopsInSystemGeo_ById(ctx context.Context, arg ListStopsInSystemGeo_ByIdParams) ([]Stop, error)
